...
pub mod open {
    ...
    html_case_macro!(HtmlCase2, super);
    ...
    mod multi {
        ...
        mod test {
            use super::parse;
            use crate::parse::blocks::block::leaf::html::case_2 as closed;
            ...
            type Block<'a> = closed::HtmlCase2<'a>;
    ...
    mod opening {
        ...
        mod test {
            ...
            fn should_fail_with_text_before_tag() {
                assert_eq!(
                    Err("some text before <!--"),
                    opening("some text before <!--")
                );
            }
