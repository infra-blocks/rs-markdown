...
use crate::parse::blocks::block::leaf::html::{case_1::HtmlCase1, case_2::HtmlCase2};
...
pub mod open {
    use crate::parse::blocks::{
        block::leaf::html::{case_1::open::HtmlCase1, case_2::open::HtmlCase2},
    ...
    impl<'a> IOpenBlock<'a> for Html<'a> {
        ...
        fn stage(&mut self, line: &'a str) -> Result<&'a str, ()> {
            match self {
                ...
                // Self::Case7(case) => case.stage(line).map_err(|_| ()),
            }
        }
